...
(function() {
  ...
  document.querySelector('input[name="feedback"]').addEventListener('input', function() {
...
document.getElementById('popupButton').addEventListener('click', function() {
  ...
  document.getElementById('overlay').classList.toggle('opacity-50');
});
...
document.getElementById('leftBox').addEventListener('click', function(event) {
